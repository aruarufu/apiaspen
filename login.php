...
$query="SELECT a.* , b.nama AS jabatan FROM user a LEFT JOIN jabatan b ON a.jabatan_id = b.jabatan_id WHERE a.username ='$myusername' and a.password=md5('$mypassword')";
...
if($row > 0){
        ...
        if(empty($foto)){
                $foto =  'https://apiaspen.000webhostapp.com/apiaspen/profile/photo.jpg';
        }else{
                $foto =  'https://apiaspen.000webhostapp.com/apiaspen/profile/'.$foto;
        }
